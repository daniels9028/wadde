  ...
  return (
    <section className="container px-4 mx-auto my-20 lg:px-10">
      <div className="flex flex-col">
        <h4 className="lg:text-[40px] text-[30px] font-bold">
        ...
        <div className="flex lg:flex-row flex-col items-center justify-center w-full gap-8 mt-10">
          <div className="bg-[#E1E1E9] overflow-hidden rounded-lg flex flex-col lg:w-1/3 w-full pt-4 px-6 h-[265px] justify-between border border-gray-400">
          ...
          <div className="bg-[#E1E1E9] overflow-hidden rounded-lg flex flex-col lg:w-2/3 w-full pt-4 px-6 h-[265px] justify-between border border-gray-400">
            <div className="flex flex-row items-center justify-between pb-4 border-b border-[#1C1C1C]/20 border-dashed">
        ...
        <div className="bg-gradient-to-b from-[#F6F6F9] to-[#EEEEF5] overflow-hidden rounded-lg flex flex-col w-full py-8 px-6 mt-8 border border-gray-400">
